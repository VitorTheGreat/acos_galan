...
<div class="content">
    ...
    {{-- Modal Edit --}}
    @foreach ($products_table as $key => $product)
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{route('produto.update', ['product' => $product])}}" method="POST">
                        @method('PATCH')
                        @csrf
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="col-4 form-group">
                                    <label for="">Quantidade Fracionada</label>
                                    <input type="text" class="form-control data-kilo" placeholder="Kilo ou Metro" id="qtd_fracionada_edit" name="qtd_fracionada" value="0">
                                </div>
                                <div class="col-4 form-group">
                                    <label for="">Preço</label>
                                    <div class="input-group">
                                        ...
                                        <input class="form-control data-money" type="text" name="preco_unitario" id="preco_unitario_edit" placeholder="Preço unitário" value="0">
                                    </div>
                                </div>
                                <div class="col-4 form-group">
                                    <label for="">Custo bruto / Preço Compra</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control data-money" id="preco_compra_edit" name="preco_compra" placeholder="Preço Compra (unidade)" value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-2 form-group">
                                    <label for="">% IPI</label>
                                    <input type="text" class="form-control data-percent" placeholder="% IPI" id="ipi_edit" name="ipi" value="0">
                                </div>
                                <div class="col-2 form-group">
                                    <label for="">% ICMS</label>
                                    <input type="text" class="form-control data-percent" placeholder="% ICMS" id="icms_edit" name="icms" value="0">
                                </div>
                                <div class="col-4 form-group">
                                    <label for="">Preço de Custo (com taxas)</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control data-money" placeholder="Preço de Custo (com taxas)" id="preco_custo_edit" name="preco_custo" value="0">
                                    </div>
                                </div>
                                <div class="col-2 form-group">
                                    <label for="">% Lucro</label>
                                    <input type="text" class="form-control data-percent" placeholder="% Lucro" id="lucro_edit" name="lucro" value="0">
                                </div>
                                <div class="col-2 form-group">
                                    <label for="">Preço de Venda</label>
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control data-money" placeholder="Preço de Venda (unidade)" id="preco_venda_edit" name="preco_venda" value="0">
                                    </div>
                                </div>
                            </div>
                            <hr />
