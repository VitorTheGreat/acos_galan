...
<html>
<head>
	<title>Ordem de Transferencia</title>
</head>
<style>
h1, p{
    text-align: center;
...
<body>
    <h1>Ordem de transferencia - Aços Galan</h1>
    <hr />

    <div>
        Data: <strong>{{$transfer[0]->updated_at}}</strong>
    </div>
    ...
    <div class="row">
        <p> 
            ...
            Assinatura do Responsavel retira

        </p>
        <br />
        <p> 
                ________________________________________________<br />
                Assinatura do Responsavel entrega ({{$transfer[0]->responsavel_entrega}})
